...
import AdminEditProduct from "./components/Admin/AdminMakeProducts/AdminEditProduct";
import AdminUserBoxContainer from "./components/Admin/AdminUserBoxes/AdminUserBoxContainer";
import OrderOptions from "./components/Orders/OrderOptions";
import SearchProducters from "./components/Product/SearchProducters";
import ShowUserOrder from "./components/Orders/ShowUserOrder";
        ...
        <barContext.Provider value={() => changingState()}>
          ...
          <Routes>
            ...
            <Route
              ...
              element={user?.role === "admin" || user?.role === "admin_one"?  <AdminEditProduct/>:<Notallowed /> }
            />
            <Route
              exact
              path="/admin/dashboard/showUsers/:id"
              element={user?.role === "admin" || user?.role === "admin_one"?  <AdminUserBoxContainer/>:<Notallowed /> }
            />
            ...
            <Route
              exact
              path={"/orders"}
              element={isAuthenticated ? <ShowUserOrder/> : <LoginSignUp />}
            />
            <Route
              exact
              path={"/order/options/:id"}
              element={isAuthenticated ? <OrderOptions/> : <LoginSignUp />}
            />
            <Route
              exact
              path={"/orders/:id"}
