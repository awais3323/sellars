...
router.route("/admin/order").put(isAuthenticatedUser,authorizeRoles("admin_one","admin","user"),UpdateOrdersAdmin).delete(isAuthenticatedUser,authorizeRoles("admin_one"),deleteOrder) // For User
